...
class ArtifactControllerTest {
    ...
    void setUp() {
        ...
        a2.setDescription("A Invisibility Cloak is a device invented by DUmbledore that resembles...");
        ...
        a3.setName("Maurader");
        a3.setDescription("A Maurader is a device invented by DUmbledore that resembles...");
        ...
        a4.setName("Staff");
        a4.setDescription("A Staff is a device invented by DUmbledore that resembles...");
        a4.setImageUrl("ImageUrl");
        this.artifacts.add(a4);

        Artifact a5 = new Artifact();
        a5.setId("1250808601744904195");
        a5.setName("Gryffindor");
        a5.setDescription("A Gryffindor is a device invented by DUmbledore that resembles...");
        ...
        a6.setDescription("A Resurrection Stone is a device invented by DUmbledore that resembles...");
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        ArtifactDto artifactDto = new ArtifactDto(
                null,
                "Remembrall",
                "A Remembrall is a magical wand",
                "ImageURL",
                null);
